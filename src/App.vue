  ...
  <div class="min-h-screen bg-black text-white p-4 md:p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <header class="mb-6 text-center">
          ...
          <h2 class="text-3xl font-bold mb-4">MEME BROWSER</h2>
        </header>

      <!-- Random Meme Section -->
      <div class="mb-16">
        <div class="flex items-center justify-center gap-4 mb-4">
          <h2 class="text-2xl font-bold">cycle random meme</h2>
          <button
            @click="randomizeMeme"
            class="p-3 rounded-full hover:bg-gray-800 transition-colors text-2xl"
            title="Get random meme"
          >
            🎲
          </button>
        </div>
        <div class="max-w-3xl mx-auto h-[420px] flex items-center justify-center" v-if="randomMeme">
          <MemeImage
